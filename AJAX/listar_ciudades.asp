...
<table border=1>
<%
Set ciudades = Conexion.Execute("select IDCIUDAD, CIUDAD, TASA_AEROPUERTO from CIUDAD")

Response.Write "<tr><th>IDCIUDAD</th><th>CIUDAD</th><th>TASA AEROPUERTO</th></tr>"

do while not ciudades.EOF
Response.Write("<tr><td>" & ciudades("IDCIUDAD") & "</td><td><a href='actualizar_ciudad.asp?id=" & ciudades("IDCIUDAD") & "'>" & ciudades("CIUDAD") & "</a></td><td>" & ciudades("TASA_AEROPUERTO") & "</td></tr>")
	ciudades.MoveNext
loop
