...
<body>
  ...
  <main>
<table border=1><tr><td><b>ELIMINAR</b></td><td><b>CIUDAD</b></td><td><b>TASA DE AEROPUERTO</b></td></tr>
<%
Set resultado = Conexion.Execute("select IDCIUDAD,CIUDAD,TASA_AEROPUERTO from CIUDAD")
do while not resultado.EOF

Response.Write("<tr><td><center><a href=eliminar_ciudad.asp?id=" & resultado("IDCIUDAD") & " ><b><font color=red>X</font></b></a></center></td><td> " & resultado("CIUDAD") & " </td><td><center>" & resultado("TASA_AEROPUERTO") &"</center></td></tr>")
